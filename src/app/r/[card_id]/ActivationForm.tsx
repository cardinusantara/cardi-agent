      ...
      <div className="w-full max-w-md overflow-hidden rounded-3xl border border-emerald-100 bg-white p-6 shadow-xl dark:border-emerald-900/40 dark:bg-zinc-900 sm:p-8">
        <div className="flex flex-col items-center text-center">
          ...
          <p className="mt-2 text-sm text-zinc-600 dark:text-zinc-400">
            Kartu fisik dengan ID <span className="font-mono font-bold text-zinc-800 dark:text-zinc-200">#{cardId}</span> sekarang telah terhubung ke profil Google Maps bisnis Anda.
          </p>
          ...
          <div className="mt-6 flex w-full flex-col gap-3">
            ...
            <a
              ...
              className="inline-flex w-full items-center justify-center gap-2 rounded-xl border border-zinc-200 bg-white px-5 py-3 text-sm font-semibold text-zinc-700 shadow-sm transition hover:bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-200 dark:hover:bg-zinc-700/60"
            >
              Buka Halaman Google Review
              <svg
                className="h-4 w-4"
                fill="none"
                viewBox="0 0 24 24"
